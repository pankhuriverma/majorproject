<%-- 
    Document   : us
    Created on : Oct 16, 2015, 1:46:12 PM
    Author     : Zee
--%>
            ...
            <div class="description_body margin-right">
                <h1>User Login</h1>
                 ...
                 <form action="US" method="POST">
                     <br> <label>User Name : </label><input type="text" name="name" value="" /><br><br>
                     <label>Password  :  </label> <input type="password" name="pass" value="" /><br><br>
                     <a href="do.jsp"><label>Reset</label></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 ...
                 </form> <a href="us1.jsp"><label>New User Registration</label></a>
