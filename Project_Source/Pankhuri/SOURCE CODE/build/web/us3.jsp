    ...
    <section id="story" class="description_content">
        <div class="limit">
            <div class="description_body margin-right">
                ...
                String q="select * from pay where userid='"+id+"' and status='De-Active' ";
                PreparedStatement pst=con.prepareStatement(q);
                ResultSet rst=pst.executeQuery();
                while(rst.next())
                {
                 String sid=rst.getString("sid");   
                 String rname=rst.getString("rname");
                ...
                <form action="Feed" method="post">
                    Service Id: &emsp;&emsp;&emsp;&emsp;&emsp;<input type="text" name="sid" value="<%=sid%>" readonly="readonly"/><br><br> 
                    Restaurant Name: &emsp;&emsp;<input type="text" name="res" value="<%=rname%>" readonly="readonly"/><br><br> 
                    Enter your Feedback: <textarea name="fb" ></textarea><br><br>    
