...
<body>
    ...
    <section id="story" class="description_content">
        <div class="limit">
            ...
            <form action="AD4" method="post">
           <table id="pro_display_table" border="0" width="406"  style=" border: 4px solid #FB9217; height: 185px;
    width: 1158px;padding-left: 20px;padding-top: 0px" >
            <tr>
                                     <td align="center" style="color: black;font-weight: 400;"><b>U-Id</b></td>
                                    <td align="center" style="color: black;font-weight: 400;"><b>U-Name</b></td>
                                    <td align="center" style="color: black;font-weight: 400;"><b>Latitude</b></td>
                                    <td align="center" style="color:#000000;font-weight: bold;"><b>Longitude</b></td>
                                    
                                      <td align="center" style="color:#000000;font-weight: bold;"><b>Category</b></td>
                                         <td align="center" style="color:#000000;font-weight: bold;"><b>Email</b></td>
                                         <td align="center" style="color:#000000;font-weight: bold;"><b>Add Service</b></td>
                                   
                                </tr>
<%
    String a12,a13,a17,a18;int a11,a14,a15,a16;String a="ava";
    
              String s133="select * from eureq ";
...
%>
<tr>                                   <td align="center" style="color:royalblue;" ><%=rr1.getString("uid")%></td>
                                    <td align="center" style="color:royalblue;" ><%=rr1.getString("un")%></td>
                                     <td align="center" style="color:royalblue;" ><%=rr1.getString("lat")%></td>
                                    <td align="center" style="color:royalblue;" ><%=rr1.getString("lon")%></td>
                                    
                                       <td align="center" style="color:royalblue;" ><%=rr1.getString("cat")%></td>
                                         <td align="center" style="color:royalblue;" ><%=rr1.getString("email")%></td>
                                        
                                      <td align="center" style="color:royalblue;" ><a href="AD4?uid=<%=rr1.getString("uid")%>">send mail </a></td>   
