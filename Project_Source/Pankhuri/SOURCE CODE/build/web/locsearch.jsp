...
//        LatLng l=new LatLng();
//        String loc[]=l.getLatLongPositions(location);
//        System.out.println(loc[0]);
//        System.out.println(loc[1]);
        Class.forName("com.mysql.jdbc.Driver");
        Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3309/pro","root","root");
        String s1="select * from dataset where location like '%"+location+"%'";
        PreparedStatement p12 = con.prepareStatement("truncate table rank");
        p12.executeUpdate();
        ...
        while(rss.next())
        {
            String hn=rss.getString("resname");
            PreparedStatement ps11=con.prepareStatement("select * from feedback where sname='"+rss.getString("resname")+"' ");
           ResultSet rs11=ps11.executeQuery();
           int pos=0,neg=0;
           while(rs11.next())
           {
           pos+=rs11.getInt("positive");
           neg+=rs11.getInt("negative");
           }
           if(pos>0)
           {
           PreparedStatement p14 = con.prepareStatement("insert into rank (hname,count) values ('"+hn+"','"+pos+"')");
           p14.executeUpdate();
           }
        }
        int ccount=0;
        PreparedStatement p156=con.prepareStatement("SELECT * FROM rank");
        ResultSet rs156=p156.executeQuery();
        while(rs156.next())
        {
           ccount=ccount+1;
        }
        ...
        if(ccount==0)
        { 
        String s12="select * from dataset where location like '%"+location+"%' ";
        PreparedStatement pszz=con.prepareStatement(s12);
        ResultSet rszz=pszz.executeQuery();
        String lat,lon,id,sname,cuisine,locat,price,type,delivery,des;
        System.out.println("if block");
        while(rszz.next())
        {        
        xx.add(rszz.getString("resname"));
        %>
        <section id="story" class="description_content">
        <div class="limit">
            <table align="center" border="1" style="color: #dc2b6b;text-align: center;width: 488px;line-height: 2;font-weight: bold;">
								<tr><td align="center">Name</td><td align="center"><%=rszz.getString("resname")%></td></tr>
                                                                <tr><td align="center">Cuisine</td><td align="center"><%=rszz.getString("cuisine")%></td></tr>
								<tr><td align="center">Location</td><td align="center"><%=rszz.getString("location")%></td></tr>
                                                                <tr><td align="center">Price for two</td><td align="center"><%=rszz.getString("price")%></td></tr>
                                                                <tr><td align="center">Type of Restaurant</td><td align="center"><%=rszz.getString("type")%></td></tr>
                                                                <tr><td align="center">Home Delivery</td><td align="center"><%=rszz.getString("delivery")%></td></tr>
                                                                <tr><td align="center">Description</td><td align="center"><%=rszz.getString("des")%></td></tr>
                                                                <tr><td align="center" colspan=2><a href="menu.jsp?sid=<%=rszz.getString("id")%>&&cuisine=<%=rszz.getString("cuisine")%>&&price=<%=rszz.getString("price")%>&&rname=<%=rszz.getString("resname")%>">Click here for Menu items</td></tr>
        ...
        {
        PreparedStatement p15=con.prepareStatement("SELECT * FROM rank ORDER BY COUNT+0 DESC");
        ResultSet rs15=p15.executeQuery();
        while(rs15.next())
        {
        xx.add(rs15.getString("hname"));
        String s12="select * from dataset where resname='"+rs15.getString("hname")+"' ";
        PreparedStatement ps=con.prepareStatement(s12);
        ...
        {
            id=rs.getString("id");
            sname=rs.getString("resname");
            cuisine=rs.getString("cuisine");
            locat=rs.getString("location");
...
%>
    ...
    <section id="story" class="description_content">
        <div class="limit">
            <table align="center" border="1" style="color: #dc2b6b;text-align: center;width: 488px;line-height: 2;font-weight: bold;">
								<tr><td align="center">Name</td><td align="center"><%=sname%></td></tr>
                                                                <tr><td align="center">Cuisine</td><td align="center"><%=cuisine%></td></tr>
								<tr><td align="center">Location</td><td align="center"><%=location%></td></tr>
                                                                <tr><td align="center">Price for two</td><td align="center"><%=price%></td></tr>
                                                                <tr><td align="center">Type of Restaurant</td><td align="center"><%=type%></td></tr>
                                                                <tr><td align="center">Home Delivery</td><td align="center"><%=delivery%></td></tr>
                                                                <tr><td align="center">Description</td><td align="center"><%=des%></td></tr>
                                                                <tr><td align="center" colspan=2><a href="menu.jsp?sid=<%=id%>&&cuisine=<%=cuisine%>&&price=<%=price%>&&rname=<%=sname%>">Click here for Menu items</td></tr>
        ...
        for(String zzop:xx)
        {
        PreparedStatement pop=con.prepareStatement("select * from dataset where location like '%"+location+"%' and resname!='"+zzop+"' ");
        ResultSet ppom=pop.executeQuery();
        while(ppom.next())
        {
        %>
          <section id="story" class="description_content">
        <div class="limit">
            <table align="center" border="1" style="color: #dc2b6b;text-align: center;width: 488px;line-height: 2;font-weight: bold;">
								<tr><td align="center">Name</td><td align="center"><%=ppom.getString("resname")%></td></tr>
                                                                <tr><td align="center">Cuisine</td><td align="center"><%=ppom.getString("cuisine")%></td></tr>
								<tr><td align="center">Location</td><td align="center"><%=ppom.getString("location")%></td></tr>
                                                                <tr><td align="center">Price for two</td><td align="center"><%=ppom.getString("price")%></td></tr>
                                                                <tr><td align="center">Type of Restaurant</td><td align="center"><%=ppom.getString("type")%></td></tr>
                                                                <tr><td align="center">Home Delivery</td><td align="center"><%=ppom.getString("delivery")%></td></tr>
                                                                <tr><td align="center">Description</td><td align="center"><%=ppom.getString("des")%></td></tr>
                                                                <tr><td align="center" colspan=2><a href="menu.jsp?sid=<%=ppom.getString("id")%>&&cuisine=<%=ppom.getString("cuisine")%>&&price<%=ppom.getString("price")%>&&rname=<%=ppom.getString("resname")%>">Click here for Menu items</td></tr>
