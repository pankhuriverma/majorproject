<%-- 
    Document   : ad3
    Created on : Oct 29, 2015, 11:15:01 AM
    Author     : Zee
--%>
<%@include file="db.jsp" %>
...
<body>
        ...
        <!-- Brand and toggle get grouped for better mobile display -->
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav main-nav  clear navbar-right ">
                    ...
                    <li><a class="color_animation" href="ad2.jsp">Add Dataset</a></li>
                      <li><a class="color_animation" href="ad3.jsp">View Restaurants</a></li>
                       <!--<li><a class="color_animation" href="docmt.jsp">DO-cmt chnge</a></li>-->
    ...
    <section id="story" class="description_content">
        <div class="limit">
            ...
            <form action="AD2">
           <table id="pro_display_table" border="0"  width="406"  style=" border: 4px solid #FB9217; height: 185px;
    width: 1158px;padding-left: 20px;padding-top: 0px;    line-height: 2;" >
            <tr>
                                    <td align="center" style="color: black;font-weight: 400;"><b>service Id</b></td>
                                    <td align="center" style="color: black;font-weight: 400;"><b>Restaurant Name</b></td>
                                    <td align="center" style="color: black;font-weight: 400;"><b>Cuisine</b></td>
                                    <td align="center" style="color:#000000;font-weight: bold;"><b>Location</b></td>
                                    <td align="center" style="color:#000000;font-weight: bold;"><b>Price</b></td>
                                    <td align="center" style="color:#000000;font-weight: bold;"><b>Type of Food</b></td>
                                    <td align="center" style="color:#000000;font-weight: bold;"><b>Delivery</b></td>
                                      <td align="center" style="color:#000000;font-weight: bold;"><b>Latitude</b></td>
                                       <td align="center" style="color:#000000;font-weight: bold;"><b>Longitude</b></td>
                                       <td align="center" style="color:#000000;font-weight: bold;"><b>Map</b></td> 
                                   
                                </tr>
<%
    String a12,a13,a17,a18;int a11,a14,a15,a16;String a="ava";
    
              String s133="select * from dataset ";
...
%>
<tr>                                   <td align="center" style="color:royalblue;" ><%=rr1.getString("id")%></td>
                                    <td align="center" style="color:royalblue;" ><%=rr1.getString("resname")%></td>
                                    
                                     <td align="center" style="color:royalblue;" ><%=rr1.getString("cuisine")%></td>
                                    <td align="center" style="color:royalblue;" ><%=rr1.getString("location")%></td>
                                    <td align="center" style="color:royalblue;" ><%=rr1.getString("price")%></td>
                                       <td align="center" style="color:royalblue;" ><%=rr1.getString("type")%></td>
                                         <td align="center" style="color:royalblue;" ><%=rr1.getString("delivery")%></td>
                                         <td align="center" style="color:royalblue;" ><%=rr1.getString("lat")%></td>
                                         <td align="center" style="color:royalblue;" ><%=rr1.getString("lon")%></td>
                                         
                                         <td align="center" style="color:royalblue;" ><a href="SearchMap.jsp?id=<%=rr1.getString("id")%>&&lat=<%=rr1.getString("lat")%>&&lon=<%=rr1.getString("lon")%>" target="_blank">View Map</a></td>                            
   <td align="center" style="color:royalblue;" ><a href="REM?name=<%=rr1.getString("resname")%>&&id=<%=rr1.getString("id")%>">Remove</a></td>                            
