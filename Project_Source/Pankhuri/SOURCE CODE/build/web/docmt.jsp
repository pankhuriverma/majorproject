...
<body>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav main-nav  clear navbar-right ">
                   <li><a class="active color_animation" href="ad1.jsp">HOME</a></li>
                    <li><a class="color_animation" href="ad2.jsp">Add New Services</a></li>
    ...
    width: 1158px;padding-left: 20px;padding-top: 0px" >
            <tr>
                                     <td align="center" style="color: black;font-weight: 400;"><b>DataOwner Name</b></td>
                                    <td align="center" style="color: black;font-weight: 400;"><b>Service Name</b></td>
                                                                          <td align="center" style="color:#000000;font-weight: bold;"><b>Location</b></td>
                                       <td align="center" style="color:#000000;font-weight: bold;"><b>No of times cmt changed</b></td>
                                      
                                </tr>
<%
    String a12,a13,a17,a18;int a11,a14,a15,a16;String a="ava";
    String f="verified";
              String s133="select * from chcmt ";
...
%>
<tr>                                   <td align="center" style="color:royalblue;" ><%=rr1.getString("don")%></td>
                                    <td align="center" style="color:royalblue;" ><%=rr1.getString("sn")%></td>
                                     <td align="center" style="color:royalblue;" ><%=rr1.getString("loc")%></td>
                                      <td align="center" style="color:royalblue;" ><%=rr1.getString("vie")%></td>
