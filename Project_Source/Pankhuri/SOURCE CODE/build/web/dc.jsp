<%-- 
    Document   : ad
    Created on : Oct 8, 2015, 7:28:39 PM
    Author     : Zee
--%>
    ...
    <section id="story" class="description_content">
        <div class="limit">
            <div class="description_body margin-right">
                <h1>Data Collector Login</h1>
                
                  <br><br>
                 <form action="DC" method="POST">
                     <br> <label>User Name : </label><input type="text" name="name" value="" autofocus /><br><br>
                     <label>Password  :  </label> <input type="password" name="pass" value=""  /><br><br>
                     <a href="ad.jsp"><label>Reset</label></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
