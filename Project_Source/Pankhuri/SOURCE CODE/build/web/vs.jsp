<%-- 
    Document   : us2
    Created on : Oct 16, 2015, 6:43:27 PM
    Author     : Zee
--%>
<%@include file="db.jsp" %>
<!DOCTYPE html>
...
out.println(lat);
String lo=request.getParameter("lo");   session.setAttribute("lo", lo);
out.println(lo);
      %>
        ...
        <div class="limit">
            <div class="description_body margin-right">
                <form action="locsearch.jsp" >
                 Search by location <input type="text" name="loc"/>  
                 <input type="submit" value="search"/>
                </form>
                <h3>Or</h3>
                  <br><br>
                 <form action="secondsearch.jsp" method="POST">
                     <br> <label>Select Price : </label>  <select  name="amt" style="width: 215px;">
                         <option>--Select--</option>
                        <option value="4500">below 4500</option>
...
<br><br>
<label>Select Cuisine : </label>  Indian <input type="checkbox" name="cuisine" value="Indian" />
                               Chinese <input type="checkbox" name="cuisine" value="Chinese" />
                               Italian <input type="checkbox" name="cuisine" value="Italian" />
                               African <input type="checkbox" name="cuisine" value="African" />
                               Asian <input type="checkbox" name="cuisine" value="Asian" />
                               Caribbean <input type="checkbox" name="cuisine" value="Caribbean" />
