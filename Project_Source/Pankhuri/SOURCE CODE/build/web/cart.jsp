...
<body>
    ...
    <td>&nbsp;</td>
         ...
         <tr>  
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Your Id</strong></b></td>
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Your Name</strong></b></td>
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Restaurant Name</strong></b></td>

                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Booked Items</strong></b></td>
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Price</strong></b></td>
                                    <td align="center" style="color:#0D72BD;font-weight: bold;font-size: 17px;"><b><strong>&nbsp;&nbsp;Payment</strong></b></td>
...
<%                        
                        ...
                        String q="select * from book where userid='"+userid+"' and status='waiting'";
                        ...
                        while(rst.next())
                                      {
                                        ...
                                        item=item.replace("]", "");
                                          ...
                                          %>
                                <tr>                                  
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=rst.getString("userid")%></td>
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=rst.getString("uname")%></td>
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=rst.getString("sname")%></td>
                                   
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=item%></td>
                                    <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<%=rst.getString("price")%></td>
                                   <td align="center" style="color:#080606;font-weight: bold;">&nbsp;&nbsp;<a href="pay.jsp?uid=<%=rst.getString("userid")%>&&email=<%=email%>&&uname=<%=rst.getString("uname")%>&&res=<%=rst.getString("sname")%>&&item=<%=item%>&&iprice=<%=rst.getString("price")%>&&sid=<%=rst.getString("sid")%>">Make Payment</a></td>
 <tr>
    <th scope="row">&nbsp;</th>
    <td>&nbsp;</td>
  </tr>
