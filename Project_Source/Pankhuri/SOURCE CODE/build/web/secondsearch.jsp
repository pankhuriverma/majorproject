<%-- 
    ...
    Created on : Feb 22, 2018, 11:10:31 PM
    Author     : DLK
--%>
...
String uid=(String)session.getAttribute("uid");
           ...
           String amtype=request.getParameter("amt");
    int amt = Integer.parseInt(amtype);
    String cuisine[]=request.getParameterValues("cuisine");
    System.out.print(cuisine.length);
    ...
    PreparedStatement p12 = con.prepareStatement("truncate table rank");
        p12.executeUpdate();
        Set <String> ss11 = new LinkedHashSet<String>();
        
    for(String cu:cuisine)
    {
        System.out.println(cu);
        PreparedStatement pst = con.prepareStatement("select * from dataset where cuisine like '%"+cu+"%' and price <= '"+amt+"' ");
        ...
        Iterator ii = ss11.iterator();
        List <String> hname = new ArrayList<String>();
        List <Integer> poss = new ArrayList<Integer>();
        
        while(ii.hasNext())
        {           
            String honame=ii.next().toString();
        PreparedStatement ps11=con.prepareStatement("select * from feedback where sname='"+honame+"' ");
           ...
           if(pos>0)
           {
           PreparedStatement p14 = con.prepareStatement("insert into rank (hname,count) values ('"+honame+"','"+pos+"')");
           p14.executeUpdate();
           }
        }
        ...
        while(rs15.next())
        {
        String s12="select * from dataset where resname='"+rs15.getString("hname")+"' and resname!='empty' ";
        PreparedStatement ps=con.prepareStatement(s12);
        ResultSet rs=ps.executeQuery();
        String lat,lon,id,sname,cuisine1,locat,price,type,delivery,des;
        
        while(rs.next())
        {
            id=rs.getString("id");
            sname=rs.getString("resname");
            cuisine1=rs.getString("cuisine");
        ...
        <div class="limit">
            <table align="center" border="1" style="color: #dc2b6b;text-align: center;width: 488px;line-height: 2;font-weight: bold;">
								<tr><td align="center">Name</td><td align="center"><%=sname%></td></tr>
                                                                <tr><td align="center">Cuisine</td><td align="center"><%=cuisine1%></td></tr>
								<tr><td align="center">Location</td><td align="center"><%=locat%></td></tr>
                                                                ...
                                                                <tr><td align="center" colspan=2><a href="menu.jsp?sid=<%=id%>&&cuisine=<%=cuisine1%>&&price=<%=price%>&&rname=<%=sname%>">Click here for Menu items</td></tr>
