<%-- 
    Document   : us1
    Created on : Oct 16, 2015, 3:28:07 PM
    Author     : Zee
--%>
<!DOCTYPE html>
<html>
        ...
        <!-- Brand and toggle get grouped for better mobile display -->
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav main-nav  clear navbar-right ">
                    <li><a class="active color_animation" href="index.jsp">HOME</a></li>
                    
                    <li><a class="color_animation" href="us.jsp">USER</a></li>
                    <li><a class="color_animation" href="ad.jsp">ADMIN</a></li>
    ...
    <section id="story" class="description_content">
        <div class="limit">
            <div class="description_body margin-right">
             ...
             <table align="center" width="773" height="330" style="border:1px solid black;    margin-left: -160px;" class="table_align">
                                   <form  action="US1" method="post">
                                       <tr><td id="label_design" ><label>First Name</label></td> <td><input type="text" required autofocus name="first"  id="first" class="text_design" placeholder="Enter the First Name"/></td>

                            <td id="label_design"  style="    max-width: 100%;
    margin-bottom: -3px;
    font-weight: bold;">Second Name</td> <td><input type="text" required autofocus name="sec"  id="first" class="text_design" placeholder="Enter the Second Name"/></td>
                        </tr>
                        <tr><td id="label_design" style="    max-width: 100%;
    margin-bottom: -3px;
    font-weight: bold;">User Name</td> <td><input type="text" required autofocus name="use"  id="first" class="text_design" placeholder="Enter the User Name"/></td>

                            <td id="label_design" style="    max-width: 100%;
    margin-bottom: -3px;
    font-weight: bold;">Password</td> <td><input type="password" required autofocus name="pas"  id="first" class="text_design" placeholder="Enter the Password"/></td>
                        </tr>

                        <tr><td id="label_design" style="    max-width: 100%;
    margin-bottom: -3px;
    font-weight: bold;">Email-Id</td> <td><input type="text" required autofocus name="email"  id="first" class="text_design" placeholder="Enter the Email-Id"/></td>

                            <td id="label_design" style="    max-width: 100%;
    margin-bottom: -3px;
    font-weight: bold;">Mobile No</td> <td><input type="text" required autofocus name="mobile"  id="first" class="text_design" placeholder="Enter the Mobile Number"/></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td id="label_design" style="    max-width: 100%;
    margin-bottom: -3px;
    font-weight: bold;">Country</td> <td><input type="text" required autofocus name="country"  id="first" class="text_design" placeholder="Enter the Country"/></td>
                        </tr>
                                       <tr><td align="center"><br/><input type="submit"></input></td>
    
    <td align="center"><a href="us1.jsp" >
  Cancel
</a>
    </td>
