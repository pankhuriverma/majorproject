...
<html>
    ...
    <body>
        ...
        sname=request.getParameter("res");
        Reviews=request.getParameter("fb");
            {
                ...
                if(P)
                {
                    PreparedStatement c=con.prepareStatement("insert into feedback(sid,sname,fb,positive,negative) values('"+Product+"','"+Category+"','"+Reviews+"','"+Date+"','"+Image+"') ");
                    c.executeUpdate();
                }
