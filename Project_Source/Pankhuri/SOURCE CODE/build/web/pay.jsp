    ...
    <section id="story" class="description_content">
        <div class="limit">
            ...
            <%
                                    ...
                                    String rname=request.getParameter("res");
                                    %>
                                    <br><br>
                                    <h2>Give your card information</h2>
                                    <br><br>
                                    <center>
                                    <form action="Pay1" method="post">
                                      
                                            <input type="hidden" name="uid" value="<%=id%>">
                                            <input type="hidden" name="serid" value="<%=sid%>">
                                            <input type="hidden" name="rname" value="<%=rname%>">
                                        Price for your Food &emsp;&emsp;&emsp;<input type="text" name="price" value="<%=price%>" readonly="readonly"><br><br>
                                        Enter your card number &emsp;<input type="text" name="card" required="required" ><br><br>
                                        Enter the Exp date &emsp;&emsp;&emsp;<input type="text" name="exp" required="required" ><br><br>
                                        Enter the CVV Number &emsp;<input type="text" name="cvv" required="required" ><br><br>
